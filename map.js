...
JF.initialize({ apiKey: "af1088c686d68f9a8be12cf65853e1ac" }); //PUT YOUR OWN KEY HERE
 
// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223118607085050", function (response) {
...
// Import Layers from DeckGL
 ...
 // YOUR MAPBOX TOKEN HERE
   mapboxgl.accessToken = "pk.eyJ1IjoiZG9yaXNkbXUxMjMiLCJhIjoiY2xhOTRsM3plMGE2ejNubzQwMGM4bHNqeCJ9.WV-vzqBh6T1RKCDgZLlrBg";
  
   const map = new mapboxgl.Map({
     container: document.body,
     style: "mapbox://styles/dorisdmu123/ckubq7s7e2fmm17o5h0i4l4ht", // Your style URL
